...
// Servo adjustment
#define _DUTY_MAX 1929  // Servo angle: D degree
#define _DUTY_NEU 1400  // Servo angle: 0 degree
#define _DUTY_MIN 777   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  ...
  return 528 + -2.82 * a_value + 7.95E-03 * pow(a_value, 2) + -1.29E-05 * pow(a_value, 3) + 8.33E-09 * pow(a_value, 4);
}
