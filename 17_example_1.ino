...
// _DUTY_MAX - _DUTY_MAX = 1846

#define _DIST_MIN 160.0   // minimum distance to be measured (unit: mm)
#define _DIST_MAX 250.0   // maximum distance to be measured (unit: mm), 오차 발생
...
float dist_prev, dist_ema = _DIST_MAX;
